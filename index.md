...
<html>
    ...
    <body>
        ...
        <div class="hidden" aw-include="mountLinks">
            <script>AWConfig={"name":"测试文库","ver":"v1.0","version":"v1.0","logo":"amWiki/images/logo.png","testing":false,"colour":"#4296eb","pageMounts":false,"githubUrl":"","libraryPrefix":""}</script>
        </div>
        <!-- js -->
        <div class="hidden">
